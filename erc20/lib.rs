...
mod filpper {
    ...
    impl BaseErc20 for MyErc20 {
        ...
        fn transfer_from(&mut self, from: AccountId, to: AccountId, value: Balance) -> Result<()> {
            ...
            if allowance < value {
                return Err(Error::InsfufficientAllowance);
            }
            self.transfer_from_to(&from,&to,value)?;
    ...
    mod tests {
        ...
        fn assert_transfer_event(
            ...
            let expected_topics = [
                encoded_into_hash(&PrefixedValue {
                    prefix: b"",
                    value: b"MyErc20::Transfer",
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"MyErc20::Transfer::from",
                    value: &expected_from,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"MyErc20::Transfer::to",
                    value: &expected_to,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"MyErc20::Transfer::value",
        ...
        fn new_works() {
            ...
            let erc20 = MyErc20::new(initial_supply);

            // The `BaseErc20` trait has indeed been implemented.
            assert_eq!(<MyErc20 as BaseErc20>::total_supply(&erc20), initial_supply);
        ...
        fn transfer_works() {
            // Constructor works.
            let initial_supply = 100;
            let mut erc20 = MyErc20::new(initial_supply);
            // Transfer event triggered during initial construction.
            let accounts =
                ink::env::test::default_accounts::<ink::env::DefaultEnvironment>();
        ...
        fn transfer_from_works() {
            ...
            assert_eq!(
                ...
                Err(Error::InsfufficientAllowance)
            );
